    ...
    <div class="bg-white rounded overflow-hidden shadow-sm">
        ...
        <div class="p-6 grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div class="lg:col-span-2">
                ...
                <p class="text-gray-700 mt-3 leading-relaxed">At {{ config('app.name', 'Kartly') }}, we believe building
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div class="p-4 border rounded">
                        <h3 class="font-semibold">Build fast</h3>
                        <p class="text-sm text-gray-700 mt-2">Pre-built components, simple architecture, and minimal
                            dependencies so you can iterate quickly.</p>
                    </div>
                    <div class="p-4 border rounded">
                        <h3 class="font-semibold">Customize</h3>
                        <p class="text-sm text-gray-700 mt-2">Easily swap out components and integrate third-party services
                            or custom business logic.</p>
                    </div>
                </div>

                <div class="mt-6">
                    <h3 class="text-lg font-semibold">What’s inside</h3>
                ...
                <div class="mt-6">
                    <h3 class="text-lg font-semibold">Our story</h3>
                    <p class="text-gray-700 mt-3 leading-relaxed">{{ config('app.name', 'Kartly') }} started with a simple
                    ...
                    <h3 class="text-lg font-semibold mt-6">What we offer</h3>
                    <ul class="mt-3 text-sm text-gray-700 list-disc list-inside">
                    ...
                    <h3 class="text-lg font-semibold mt-6">Shipping & returns</h3>
                    <p class="text-gray-700 mt-3 leading-relaxed">We aim to dispatch orders quickly and offer
                    ...
                    <h3 class="text-lg font-semibold mt-6">Our promise to customers</h3>
                    <p class="text-gray-700 mt-3 leading-relaxed">We put customers first: secure payments, clear
            ...
            <aside class="bg-gray-50 p-4 rounded">
                ...
                <p class="text-sm text-gray-700 mt-2">We are a small team dedicated to great product selection and
                ...
                <div class="mt-4 grid grid-cols-1 gap-3">
                    ...
                    <div class="flex items-center gap-3">
                        <img class="w-12 h-12 rounded-full object-cover" src="https://placehold.co/80x80?text=B"
                            alt="Team member">
                        <div>
                            <div class="font-medium">Bianca</div>
        ...
        <div class="p-6 border-t">
            <h3 class="text-lg font-semibold">Built with care</h3>
            <p class="text-gray-700 mt-3">This starter app includes concise, readable code and sensible defaults. Use it as
