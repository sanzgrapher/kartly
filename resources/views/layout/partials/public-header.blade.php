<header
            ...
            <div class="flex items-center gap-4">
                @livewire('cart-icon')
                 ...
                 <button @click="toggleTheme()"
                    class="p-2 text-gray-600 hover:text-orange-600 dark:text-gray-300 dark:hover:text-orange-400 transition-colors rounded-full hover:bg-orange-50 dark:hover:bg-gray-800 focus:outline-none"
                ...
                @auth
                    <div class="relative ml-2" id="user-menu-container">
                        ...
                        <div id="user-menu"
                            ...
                            <div
                                class="px-4 py-3 border-b border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-700/50 rounded-t-lg">
                ...
                @else
                    <div class="hidden md:flex items-center gap-3">
                        <a href="{{ route('login') }}"
                            class="text-sm font-medium text-gray-700 hover:text-orange-600 dark:text-gray-300 dark:hover:text-orange-400 transition-colors">Log
                            in</a>
    ...
    <div id="mobile-menu"
        class="hidden md:hidden border-t border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900">
