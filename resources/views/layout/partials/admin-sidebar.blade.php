...
<aside id="adminSidebar"
    ...
    <nav class="px-4 pb-6 overflow-y-auto" style="max-height: calc(100vh - 88px);">
        <div class="mb-4">
            <div class="px-3 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">General</div>
            <ul class="space-y-1">
                <li>
                    <a href="{{ route('admin.dashboard') }}"
                        class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-orange-50 dark:hover:bg-gray-700 {{ request()->routeIs('admin.dashboard') ? 'bg-orange-200 dark:bg-orange-900 text-orange-600 dark:text-orange-300' : 'text-gray-700 dark:text-gray-300' }}">
        ...
        <div class="mb-4">
            ...
            <ul class="space-y-1">
                <li>
                    <a href="{{ route('about') }}"
                        class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-orange-50 dark:hover:bg-gray-700 {{ request()->routeIs('about') ? 'bg-orange-200 dark:bg-orange-900 text-orange-600 dark:text-orange-300' : 'text-gray-700 dark:text-gray-300' }}">
                        <span class="text-sm font-medium">About</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('contact') }}"
                        class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-orange-50 dark:hover:bg-gray-700 {{ request()->routeIs('contact') ? 'bg-orange-200 dark:bg-orange-900 text-orange-600 dark:text-orange-300' : 'text-gray-700 dark:text-gray-300' }}">
        ...
        <div class="mb-4">
            <div class="px-3 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Catalog</div>
            <ul class="space-y-1">
                <li>
                    <a href="{{ route('admin.categories.index') }}"
                        class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-orange-50 dark:hover:bg-gray-700 {{ request()->routeIs('admin.categories.*') ? 'bg-orange-200 dark:bg-orange-900 text-orange-600 dark:text-orange-300' : 'text-gray-700 dark:text-gray-300' }}">
                        <span class="text-sm font-medium">Categories</span>
                    </a>
                </li>
                <li>
                    <a href="{{ route('admin.products.index') }}"
                        class="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-orange-50 dark:hover:bg-gray-700 {{ request()->routeIs('admin.products.*') ? 'bg-orange-200 dark:bg-orange-900 text-orange-600 dark:text-orange-300' : 'text-gray-700 dark:text-gray-300' }}">
        ...
        <div class="mb-4">
            <div class="px-3 py-2 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase">Sales</div>
            <ul class="space-y-1">
                <li>
