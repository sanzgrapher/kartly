<footer class="mt-12 bg-white border-t border-gray-200">
    <div id="site-contact" class="max-w-6xl my-4 mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        <!-- Brand / About -->
        <div>
            <a href="#" class="inline-block text-2xl font-semibold text-orange-600">Kartly</a>
            <p class="text-sm text-gray-600 mt-3">Draft tagline: Fast, Reliable, and Delightful shopping experiences. This is placeholder text for Kartly's short description.</p>
        ...
        <div>
            ...
            <ul class="mt-3 space-y-2 text-sm text-gray-600">
                ...
                <li><a href="#" class="hover:text-orange-600">Shop</a></li>
