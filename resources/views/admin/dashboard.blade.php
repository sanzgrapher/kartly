...
@section('content')
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
        <div class="bg-white p-4 rounded-lg border border-gray-200">
            ...
            <div class="text-2xl font-bold text-gray-900">{{ $stats['users'] ?? 'n/a' }}</div>
        </div>
        <div class="bg-white p-4 rounded-lg border border-gray-200">
            <div class="text-sm font-medium text-gray-600">Orders</div>
            <div class="text-2xl font-bold text-gray-900">{{ $stats['orders'] ?? 'n/a' }}</div>
        </div>
        <div class="bg-white p-4 rounded-lg border border-gray-200">
            <div class="text-sm font-medium text-gray-600">Revenue</div>
            <div class="text-2xl font-bold text-gray-900">Rs {{ number_format($stats['revenue'] ?? 0, 2) }}</div>
        </div>
        <div class="bg-white p-4 rounded-lg border border-gray-200">
            <div class="text-sm font-medium text-gray-600">Products</div>
            <div class="text-2xl font-bold text-gray-900">{{ $stats['products'] ?? 'n/a' }}</div>
        </div>
        <div class="bg-white p-4 rounded-lg border border-gray-200">
            <div class="text-sm font-medium text-gray-600">Avg Order Value</div>
            <div class="text-2xl font-bold text-gray-900">Rs {{ number_format($stats['avgOrderValue'] ?? 0, 2) }}</div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div class="bg-white p-6 rounded-lg shadow border border-gray-200">
            <h2 class="text-lg font-medium mb-4">Orders (Last 30 Days)</h2>
            <canvas id="ordersChart" height="120"></canvas>
        </div>
        <div class="bg-white p-6 rounded-lg shadow border border-gray-200">
            <h2 class="text-lg font-medium mb-4">Revenue (Last 30 Days)</h2>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
        <div class="bg-white p-6 rounded-lg shadow border border-gray-200">
            <h2 class="text-lg font-medium mb-4">Order Status Breakdown</h2>
