            ...
            <div class="space-y-4">
                <div>
                    <input type="text" name="q" value="{{ old('q', $q) }}" placeholder="Search products or categories"
                        class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-200" />
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <select name="category_id"
                            class="w-full px-3 py-2 border border-gray-200 rounded-lg focus:ring-2 focus:ring-orange-200">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Min Price (Rs.)</label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Max Price (Rs.)</label>
