    ...
    <div class="container mx-auto flex flex-col min-h-screen">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-0 flex-1">
            ...
            <div class="md:col-span-3 bg-white dark:bg-gray-800 rounded-r-lg border border-l-0 border-gray-200 dark:border-gray-700 p-6">
                <div class="mb-8">
                    <h1 class="text-3xl font-semibold mb-2 dark:text-white">Edit Address</h1>
                    <p class="text-gray-600 dark:text-gray-400">Update your delivery address details</p>
                </div>

                <form action="{{ route('addresses.update', $address) }}" method="POST" class="max-w-2xl">
                    @csrf
                    @method('PATCH')
                    ...
                    <div class="mb-6">
                        ...
                        <input type="text" id="country" name="country" value="{{ old('country', $address->country) }}"
                            class="w-full border border-gray-300 dark:border-gray-600 rounded-md px-4 py-2 focus:outline-none focus:border-orange-500 focus:ring-1 focus:ring-orange-500 bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
