...
@section('content')
    ...
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-800 dark:text-white mb-2">{{ $category->name }}</h1>
    ...
    @else
        <div class="bg-gray-50 dark:bg-gray-700 border border-gray-200 dark:border-gray-600 rounded-lg p-12 text-center">
            ...
            <h3 class="text-lg font-semibold text-gray-800 dark:text-white mb-1">No products available</h3>
